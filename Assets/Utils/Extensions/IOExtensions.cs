...
namespace GameEngine.Utils.Extensions
{
	public static class IOExtensions
	{
		...
		public static Vector2Int ReadVector2Int(this BinaryReader reader) => new Vector2Int(reader.ReadInt32(),reader.ReadInt32());
		public static Vector3Int ReadVector3Int(this BinaryReader reader) => new Vector3Int(reader.ReadInt32(),reader.ReadInt32(),reader.ReadInt32());
		public static Vector4Int ReadVector4Int(this BinaryReader reader) => new Vector4Int(reader.ReadInt32(),reader.ReadInt32(),reader.ReadInt32(),reader.ReadInt32());
