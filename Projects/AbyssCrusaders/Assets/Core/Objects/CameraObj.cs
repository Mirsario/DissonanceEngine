...
namespace AbyssCrusaders.Core
{
	public class CameraObj : GameObject2D
	{
		...
		public override void OnInit()
		{
			...
			AudioSource.defaultMaxDistance = 1000f;

			var listener = Instantiate<GameObject2D>("AudioListener").AddComponent<AudioListener>();
			listener.Transform.parent = Transform;
			listener.Transform.LocalPosition = new Vector3(0f,0f,-Depth+200f);
