...
namespace SurvivalGame
{
	public class GameInput
	{
		...
		public static void Initialize()
		{
			...
			lookX = Input.RegisterTrigger("LookX",new[] { new InputBinding("Mouse X",mouseSensitivity,0f),"GamePad0 Axis3","-Left","+Right" });
			lookY = Input.RegisterTrigger("LookY",new[] { new InputBinding("Mouse Y",mouseSensitivity,0f),"GamePad0 Axis4","-Up","+Down" });
