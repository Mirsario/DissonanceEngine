...
namespace GameEngine
{
	...
	{
		public Rect view = new Rect(0f,0f,1f,1f);
		public Rect ViewPixel
		{
			get => new Rect(
				Mathf.Floor(view.x*Graphics.ScreenWidth),
				Mathf.Floor(view.y*Graphics.ScreenHeight),
				Mathf.Floor(view.width*Graphics.ScreenWidth),
				Mathf.Floor(view.height*Graphics.ScreenHeight)
			);
			set {
				view.x = value.x/Graphics.ScreenWidth;
				view.y = value.y/Graphics.ScreenHeight;
				view.width = value.width/Graphics.ScreenWidth;
				view.height = value.height/Graphics.ScreenHeight;
			}
		}
		...
		{
			Graphics.cameraList.Add(this);
		}
		protected override void OnDisable()
		{
			Graphics.cameraList.Remove(this);
		}
