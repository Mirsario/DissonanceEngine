...
internal static partial class CameraUpdating
{
	[EntitySystem, CalledIn<RenderUpdate>]
	static partial void UpdateCameras(ref Camera camera, in Transform transform)
	{
