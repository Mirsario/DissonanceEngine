...
{
	[MessageSubsystem]
	partial void DisposeColliders(in ComponentRemovedMessage<CapsuleCollider> message, World world)
	{
	...
	[EntitySubsystem]
	partial void Update(World world, Entity entity, ref CapsuleCollider collider)
	{
